...
\begin{tikzpicture}[scale=3]
  \bear
  \draw[red]  (-0.3, 1.55) -- (0.3, 1.55) -- (0,1) --cycle; %v-neck
  \draw[red]  (0, 1.55)     circle (0.5) ;
  \begin{scope}[even odd rule]
  \bearwear[leftarm=yellow,
            rightarm=red,
            body={blue},
            body pattern={pattern={Stars[points=6,radius=0.5mm,distance=1.5mm]},pattern color=yellow},
            body deco = {\path ([yshift=-2mm]bearchest) pic{hippo1};}]
...
\begin{tikzpicture}
  \bear
  \begin{scope}[even odd rule]
  \bearwear[leftarm=red,rightarm=yellow,body=green,muscle shirt]
  %\node at (0,0.8){\includegraphics[width=0.5cm,trim=2cm 0.7cm 2cm 0.7cm,clip]{flag_yellow_eps}};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  \bear
  \begin{scope}[even odd rule]
  \bearwear[shirt={shade,
            top color=blue, bottom color=red},t-shirt,v-neckline]
  % \fill[red,rotate around={-50:(0.525,0.9)}](0.525,0.9) ellipse (0.35 and 0.15); %right arm
 % \fill[red,rotate around={50:(-0.525,0.9)}] (-0.525,0.9) ellipse (0.35 and 0.15);
 % \fill[europablau] (0,0.75) ellipse (0.55 and 0.65);
  %\fill[europablau] (0,0.7) ellipse (0.35 and 0.4);
